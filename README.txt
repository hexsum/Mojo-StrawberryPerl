...
http://share-10066126.cos.myqcloud.com/Mojo-StrawberryPerl-20161107.rar

【运行】
1、运行批处理 start_mojo_webqq.bat/start_mojo_weixin.bat/start_mojo_weixin_controller.bat 来启动相应程序
2、扫码登陆，二维码图片会自动展示
3、如存在有效Cookie则无需扫码
